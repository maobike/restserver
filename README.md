...
dependencies : 
  ...
  express : "^4.17.1", para facil uso de servidor rest
  express-validator : "^6.10.0", para validar campos recividos en el servicio rest
  jsonwebtoken : "^8.5.1", para crear tokens JWT
  mongoose : "^5.11.18", para coneccion con DB mongo
```
